...
const fa = function (done) {
    vfs.src('node_modules/@fortawesome/fontawesome-free/scss/*.*').pipe(gulp.dest('./frontend/scss/font-avesome/scss'));
    vfs.src('node_modules/@fortawesome/fontawesome-free/webfonts/*.*')
    .pipe(gulp.dest('./frontend/scss/font-avesome/webfonts'))
